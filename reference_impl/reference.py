...
train(train_dataloader, encoder, decoder, 4, print_every=5, plot_every=5)

encoder.eval()
decoder.eval()
evaluateRandomly(encoder, decoder)

def showAttention(input_sentence, output_words, attentions, file_name: str):
    fig = plt.figure()
...
def evaluateAndShowAttention(input_sentence: str):
    ...
    showAttention(input_sentence, output_words, attentions[0, :len(output_words), :], input_sentence.replace(" ", "_") + ".png")
